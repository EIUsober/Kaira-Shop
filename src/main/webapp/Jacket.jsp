...
<body>
	...
	<div class="search-popup">
		<div class="search-popup-container">
			...
			<ul class="cat-list">
				<li class="cat-list-item"><a href="UserControl?mode=getProductByCategory&category=jacket" title="Jackets">Jackets</a>
				</li>
				<li class="cat-list-item"><a href="UserControl?mode=getProductByCategory&category=shirt" title="T-shirts">T-shirts</a>
				</li>
				<li class="cat-list-item"><a href="UserControl?mode=getProductByCategory&category=perfume" title="Perfumes">Handbags</a>
				</li>
			</ul>
		</div>
	</div>
	...
	<section class="categories overflow-hidden">
		<div class="product-grid">
			<!-- Product 1 -->
			<c:forEach items="${listProductByCategory}" var="l">
				<div class="product-card">
					<img src="${l.getImageUrl()}" alt="Product Image">
					<h3>${l.getProductName()}</h3>
					<p>$ ${l.getPrice()}</p>
					<a href="UserControl?mode=detail&id=${l.getProductId()}" class="add_cart_btn">
                    <span>
                      See more detail
                    </span>
                  </a>
